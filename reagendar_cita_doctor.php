    ...
    <table border="1">
        ...
        <?php foreach ($citas as $cita): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($cita['apellidos']); ?></td>
                    <td><?php echo $cita['fecha'] ? htmlspecialchars($cita['fecha']) : 'Sin citas'; ?></td>
                    <td><?php echo $cita['hora'] ? htmlspecialchars($cita['hora']) : ''; ?></td>
                    <td><?php echo $cita['tipo_tratamiento'] ? htmlspecialchars($cita['tipo_tratamiento']) : ''; ?></td>
                    <td><?php echo $cita['estado'] ? htmlspecialchars($cita['estado']) : ''; ?></td>
                    <td>
                    <form action="reagendar.php" method="POST">
                    <input type="hidden" name="id_paciente" value="<?php echo $cita['id_paciente']; ?>">
                    <button type="submit">Volver a agendar</button>
                </form>
                    </td>
                </tr>
            <?php endforeach; ?>
